...
// Right now I have these screwed up and the player cards go to the dealer area
...
playerView.add(firstCard);
playerView.add(secondCard);
...
function newGame() {
	...
	// Deal and Display cards - the old way
	...
	Ti.API.info("It's a " + dealer_hand[0].num + " " + dealer_hand[0].suit);
	Ti.API.info("It's a " + dealer_hand[1].num + " " + dealer_hand[1].suit);
